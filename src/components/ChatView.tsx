...
function MessageRender({
  ...
  // Skip displaying tool result messages directly — they're shown inside ToolCallBlock
  if (message.role === 'tool') return null
  // System messages are normally suppressed; show scheduler / reminder banners
  ...
  // Thinking message — collapsible, like Claude Code
